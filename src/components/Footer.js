...
const Footer = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 pt-4 pb-8 xl:pt-8">
      <div class=" mx-auto px-4 sm:px-6 md:px-8 text-gray-400 dark:text-gray-300">
        <ul class="text-lg font-light pb-8 flex flex-wrap justify-center">
          <li class="w-1/2 md:w-1/3 lg:w-1/5 relative left-[5%]">
            <div class="">
          ...
          <li class="w-1/2 md:w-1/3 lg:w-1/5 relative left-[5%]">
            <div class="">
              ...
              <ul>
                <li class="mb-4 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
                  <a href="/">Love Shayari</a>
                </li>
                <li class="mb-4 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
                  <a href="/">Broken Shayari</a>
                </li>
                <li class="mb-4 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
                  <a href="/">Dard Shayari</a>
                </li>
                <li class="mb-4 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
                  <a href="/">Bewafa Shayari</a>
                </li>
                <li class="mb-4 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
                  <a href="/">Ghazal Shayari</a>
                </li>
                <li class="mb-4 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
                  <a href="/">Alone Shayari</a>
                </li>
              </ul>
            </div>
          </li>
        ...
        <div class="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
          © 2022 Tamasha e Jindagi - All Right Reserved
        </div>
      </div>
    </div>
  );
