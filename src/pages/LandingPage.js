...
import BG from "../images/shayari.jpg";
...
const LandingPage = () => {
  return (
    <div>
      <Navbar />
      <div
        className="h-[500px] w-[100vw] bg-cover"
        style={{ backgroundImage: `url(${BG})` }}
      >
        <div className="text-white text-center pt-24 md:text-8xl text-4xl font-semibold">
          Meri Soch Ke Alfaz
        </div>
        <div className="text-white text-center pt-16 text-3xl">
          Hear or post your best shayaries here
        </div>
      </div>

      <div class="w-full bg-white md:p-12 p-4">
        <div class="title text-center">
          <p class="text-4xl font-bold text-gray-800 mb-12">Posts</p>
        </div>
        ...
        <div className="text-center">
          <Link to="/posts">
            <button class="bg-blue-500 hover:bg-blue-700 mt-12 justify-center text-white font-bold py-2 px-4 border border-blue-700 rounded">
      ...
      <div class="w-full bg-white md:p-12 p-4">
        <div class="title text-center">
          <p class="text-4xl font-bold text-gray-800 mb-12">Videos</p>
        </div>
        <div class="header flex items-end justify-between mb-12">
          <select
            class="block w-44 relative bottom-14 md:bottom-0 md:w-52 text-gray-700 py-2 px-2 md:px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
      ...
      <div class="w-full bg-white md:p-12 p-4">
        <div class="title text-center">
          <p class="text-4xl font-bold text-gray-800 mb-12">Audios</p>
        </div>
        <div class="header flex items-end justify-between mb-12">
          <select
            class="block w-44 relative bottom-14 md:bottom-0 md:w-52 text-gray-700 py-2 px-2 md:px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
